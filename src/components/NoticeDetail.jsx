// // src/components/NoticeDetail.js - Updated to use ImageCarousel
...
//       <div className="p-4">
//         {/* Category, important tag, and date */}
...
// // src/components/NoticeDetail.js - Fixed HTML content rendering
// import React from 'react';
// import ImageCarousel from './ImageCarousel';
...
const NoticeDetail = ({ notice, onPrevious, onNext, currentIndex, totalCount }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
      ...
      {/* Navigation between notices - Moved below attachments */}
