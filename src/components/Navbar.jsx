...
const Navbar = () => {
  ...
  return (
    <nav className={`${darkMode ? 'bg-gray-800' : 'bg-indigo-600'} shadow-md transition-colors duration-200`}>
            ...
            {isAuthenticated ? (
              ...
              <>
                ...
                <Link
                  to="/signup"
                  className={`ml-4 ${
                    darkMode ? 'bg-gray-700 hover:bg-gray-600' : 'bg-indigo-500 hover:bg-indigo-400'
